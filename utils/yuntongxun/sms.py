...
_accountSid = '8a216da870e2267e01713b415c673091'

# 说明：主账号Token，登陆云通讯网站后，可在控制台-应用中看到开发者主账号AUTH TOKEN
_accountToken = 'db8eb1d2de05435d8e7ff2ab923f916a'

# 请使用管理控制台首页的APPID或自己创建应用的APPID
_appId = '8a216da870e2267e01713b415ccc3098'
...
if __name__ == '__main__':
    ...
    result = None
    while True:
        result = ccp.send_template_sms('17515070080', ['1314521', 5], "1")
        if result == 0:
            print('短信验证码发送成功！')
            break
